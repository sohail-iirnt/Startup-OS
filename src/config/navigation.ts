...
export const navigationSections: NavigationSection[] = [
  ...
  { label: 'Finance', items: [{ label: 'Finance', path: '/finance', icon: CircleDollarSign, permission: 'finance.view' }, { label: 'Payroll', path: '/finance/payroll', icon: ReceiptText, permission: 'payroll.view' }] },

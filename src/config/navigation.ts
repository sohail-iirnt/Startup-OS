...
import { BarChart3, BriefcaseBusiness, CalendarDays, CheckSquare, CircleDollarSign, FileText, Gauge, Lightbulb, Settings, Users, Globe, MailPlus, ShieldCheck, Target, UserCheck, CalendarRange } from 'lucide-react'
...
export const navigationSections: NavigationSection[] = [
  ...
  { label: 'Operations', items: [{ label: 'Tasks', path: '/tasks', icon: CheckSquare, permission: 'tasks.view' }, { label: 'Team', path: '/team', icon: Users, permission: 'members.view' }, { label: 'Invitations', path: '/team/invitations', icon: MailPlus, permission: 'members.approve' }, { label: 'Attendance', path: '/attendance', icon: UserCheck, permission: 'attendance.view' }, { label: 'Leave', path: '/leave', icon: CalendarRange, permission: 'leave.view' }, { label: 'Calendar', path: '/calendar', icon: CalendarDays, permission: 'calendar.view' }, { label: 'Goals & Targets', path: '/goals', icon: Target, permission: 'goals.view' }] },

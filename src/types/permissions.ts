...
// These capabilities change workspace configuration or another member's access.
// They remain owner/admin-only so custom grants cannot create a privilege-escalation path.

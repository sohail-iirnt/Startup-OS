...
function Sidebar({ mobileOpen, onClose }: SidebarProps) {
  ...
  const workspaceMenuAvailable = canManageWorkspace || hasPermission('settings.manage')
        ...
        <div className="border-b border-[var(--os-border)]">
          <div className="flex h-[76px] items-center px-6">
            <div className="flex min-w-0 items-center gap-3">
              ...
              <div className="min-w-0"><p className="truncate text-sm font-semibold tracking-tight text-[var(--os-text)]">Startup OS</p><p className="truncate text-[11px] text-[var(--os-text-muted)]">Founder Command Center</p></div>
            </div>
          </div>
